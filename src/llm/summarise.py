...
from llm.prompt_templates.summarise import prompt_mapping
...
class TextSummarizer:
    ...
    def summarize(self, text: str, type: str = "default", retrieval_query: str = None):
        if type == "default":
            ...
            prompt_template = PromptTemplate(
                input_variables=["text"], template=self.prompts["RAG"]
            )
